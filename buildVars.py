...
addon_info = AddonInfo(
	...
	addon_name="internet_speed_checker",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Internet Speed Checker"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("An add-on to check your internet speed (download, upload, ping) with NVDA."),
	# version
	addon_version="1.0.4",
	...
	addon_url="https://github.com/anhlocvu/Internet-speed-checker",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/anhlocvu/Internet-speed-checker",
...
pythonSources = ["addon/globalPlugins/internetSpeedChecker/*.py"]
